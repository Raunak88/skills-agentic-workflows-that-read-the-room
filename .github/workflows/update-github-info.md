...
4. Use web-fetch to read `https://awesome-copilot.github.com/workflows/`.
  If web-fetch is unavailable, use `curl -fsSL` for these three public URLs only.
